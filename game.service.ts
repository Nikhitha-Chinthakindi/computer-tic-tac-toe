    ...
    */
    GetCompletingSet() {
        ...
        // Block#1
          ...
          if( block1.free == false && block5.free == true && block9.free == false && ( block1.value == 'cross' && block1.value == block5.value) ) {
            return 9;
         
            }else if( block5.free == false && block9.free == true && block1.free == false && ( block5.value == 'cross' && block5.value == block9.value) ) {
            return 1;

        } 
         else if( block1.free == false && block2.free == true && block3.free == false && ( block1.value == 'cross' && block1.value == block3.value) ) {
            return 2;
        ...
        // Block#4
         ...
         else if( block4.free == false && block7.free == true && block1.free == false && ( block4.value == 'cross' && block4.value == block7.value) ) {
            return 1;
        ...
        // Block#7
         ...
         } else if( block7.free == false && block4.free == true && block1.free == false && ( block7.value == 'cross' && block7.value == block4.value) ) {
            return 1;
        ...
        else if( block8.free == false && block5.free == true && block2.free == false && ( block8.value == 'cross' && block8.value == block5.value) ) {
            return 2;
        }
        else if( block9.free == false && block5.free == true && block1.free == false && ( block9.value == 'cross' && block9.value == block5.value) ) {
            return 1;
        }else if( block9.free == false && block5.free == true && block1.free == false && ( block9.value == 'cross' && block9.value == block5.value) ) {
            return 1;
